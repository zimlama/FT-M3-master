...
// variable creada  para el problemA con el objetivo de usar filesystem.readfile
...
function problemA () {
  ...
  // .then(blue); // la forma corta ya que estamos ejecuntando un objeto que invoca un argumento
